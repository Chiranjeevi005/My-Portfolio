                ...
                <div className="contact-element">
                  ...
                  <div className="space-y-6">
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 dark:text-gray-300">you@example.com</p>
                      </div>
                    </div>
                  ...
                  <div className="mt-10">
                    ...
                    <div className="flex space-x-4">
                      <a href="#" className="bg-gray-200 dark:bg-gray-700 p-3 rounded-full text-gray-700 dark:text-gray-300 hover:text-primary-600 dark:hover:text-primary-400 transition-colors">
