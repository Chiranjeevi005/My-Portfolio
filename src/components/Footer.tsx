...
const Footer = () => {
  return (
    <footer className="bg-light-bgPrimary dark:bg-dark-bgPrimary border-t border-light-border dark:border-dark-border pt-12 pb-8 transition-colors duration-700">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center mb-8">
          ...
          <div className="flex space-x-6">
            <Link href="#" className="text-light-textPrimary dark:text-dark-textPrimary hover:text-light-textAccent dark:hover:text-dark-textAccent transition-colors duration-300 transform hover:scale-110">
