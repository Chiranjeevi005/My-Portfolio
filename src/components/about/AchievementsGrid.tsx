      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        ...
        <div className="md:hidden mt-16">
          <div className="relative">
            ...
            <div className="absolute left-4 top-0 bottom-0 w-0.5 bg-light-textAccent/30 dark:bg-dark-textAccent/30"></div>
            ...
            {achievements.map((achievement, index) => (
              ...
              >
                {/* Timeline Node */}
                <div className="absolute left-4 top-2 w-4 h-4 rounded-full bg-light-textAccent dark:bg-dark-textAccent transform -translate-x-1/2"></div>
                
                {/* Card */}
                <div className="bg-light-bgSurface dark:bg-dark-bgSurface rounded-2xl p-5 shadow-lg border border-light-border dark:border-dark-border h-[450px] flex flex-col">
                  <div className="inline-block px-2 py-1 bg-light-textAccent/10 dark:bg-dark-textAccent/10 text-light-textAccent dark:text-dark-textAccent rounded-full text-xs font-medium mb-3">
                    {achievement.year}
                  </div>
                  
                  {/* Certificate Image */}
                  <div className="w-full h-48 rounded-lg bg-gradient-to-br from-light-bgSurface to-light-textAccent/5 dark:from-dark-bgSurface dark:to-dark-textAccent/5 mb-3 flex items-center justify-center overflow-hidden border border-light-border dark:border-dark-border">
                    <div className="relative w-full h-full flex items-center justify-center">
                      <div className="absolute inset-0 bg-gradient-to-br from-light-textAccent/5 to-light-textHighlight/5 dark:from-dark-textAccent/5 dark:to-dark-textHighlight/5"></div>
                      <div className="relative z-10 text-center p-3">
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12 text-light-textAccent/30 dark:text-dark-textAccent/30 mx-auto mb-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                        </svg>
                        <p className="text-light-textSecondary/50 dark:text-dark-textSecondary/50 text-[10px] font-medium">Certificate Preview</p>
                      </div>
                      <div className="absolute top-2 right-2 w-8 h-8 rounded-full bg-light-textAccent/10 dark:bg-dark-textAccent/10 flex items-center justify-center">
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-light-textAccent/30 dark:text-dark-textAccent/30" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                        </svg>
                      </div>
                    </div>
                  ...
                  <h3 className="text-lg font-bold text-light-textPrimary dark:text-dark-textPrimary mb-1">
                    {achievement.title}
                  </h3>
                  
                  <p className="text-light-textAccent dark:text-dark-textAccent text-sm font-medium mb-2">
                    {achievement.issuer}
                  </p>
                  
                  <p className="text-light-textSecondary dark:text-dark-textSecondary text-sm mb-3 flex-grow">
                    {achievement.description}
                  </p>
                  
                  <button className="text-light-textAccent dark:text-dark-textAccent font-medium text-sm hover:underline mt-auto inline-flex items-center">
        ...
        <div className="md:hidden flex justify-center mt-8">
          <div className="w-6 h-6 rounded-full bg-gradient-to-r from-light-textAccent to-light-textHighlight dark:from-dark-textAccent dark:to-dark-textHighlight flex items-center justify-center animate-pulse">
            <div className="w-3 h-3 rounded-full bg-white dark:bg-dark-bgPrimary"></div>
          </div>
        </div>
      </div>
    </section>
